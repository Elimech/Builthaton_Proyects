...
def analyze_commit(commit_text: str) -> str:
    try:
...
def answer_question(analysis_context: str, question: str) -> str:
    prompt = f"""
    You are a senior software engineer AI.

    You already analyzed a Git repository.
    Below is the analysis context.
